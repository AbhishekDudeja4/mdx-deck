...
* Completing the optimised **_Progressive Web App (PWA)_** to enhance feasibiity and testing of the product
* Integrating the 3 features with portable hardware : **_Raspberry Pi & USB cameras_** on the dash
* Making the project **open source** and available to the community for continual development
